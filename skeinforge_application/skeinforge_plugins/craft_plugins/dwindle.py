...
class DwindleRepository:
	...
	def __init__(self):
		...
		self.slowdownFlowRateMultiplier = settings.FloatSpin().getFromValue(0.6, 'Slowdown Flow Rate Multiplier (ratio):', self, 1.0, 0.8)
...
class DwindleSkein:
	...
	def addThread(self):
		...
		slowdownFlowRateMultiplier = self.repository.slowdownFlowRateMultiplier.value
